        ...
        <React.Fragment>
                        ...
                        <Toolbar disableGutters sx={{ color: "#5f5f5f", display: "flex", alignItems: "center" }}>
                            <Grid container justifyContent={'space-between'} alignItems={"center"}>
                                ...
                                <Grid item sx={{ display: 'flex' }}>
                                    ...
                                    <Avatar sx={{ display: { xs: "none", md: "inline-flex" }, background: "#fff", border: `2px solid ${colors.primary}`, marginLeft: "7px", }} onClick={handleProfileClick}><PersonOutlineSharp sx={{ color: colors.primary, fontSize: "26px" }} /></Avatar>
                                </Grid>
                            </Grid>
                        </Toolbar>
                    </Container>
            ...
            >
                ...
                {CurrentUser &&
                    <>
                        <Box sx={{p:"10px 13px"}}>
                            <Typography sx={{fontWeight:"600"}}>{Guest ? CurrentUser.displayName + " (Guest)" : CurrentUser.displayName}</Typography>
                        </Box>
                        <Divider/>
                        <Link to="/login" style={{ textDecoration: "none", color: "black" }}><MenuItem onClick={handleProfileClose}>
                            Login
            ...
            <Drawer open={SideBaropen} variant="temporary" anchor="right" anchorEl={SideBaranchorEl} onClick={handleSideBarClose} onClose={handleSideBarClose}>
                <Box container sx={{ justifyContent: "center", alignItems: "center", padding: "1rem", display: "flex", flexDirection: "column" }}>
                    ...
                    <Typography>{Guest ? CurrentUser?.displayName + " (Guest)" : CurrentUser?.displayName}</Typography>
                </Box>
