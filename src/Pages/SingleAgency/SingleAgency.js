...
const SingleAgency = () => {
  ...
  return (
    <Grid container sx={{ marginTop: { md: "5rem", xs: "3rem" }, padding: "3rem 1rem", justifyContent: "center" }}>
      <Helmet><title>{NgoTitle} - Savarrior</title></Helmet>
      ...
      <Grid item sx={{ width: { md: "40%", xs: "100%" }, px: { md: "1rem", xs: "0" }, pl: { md: "2rem", xs: "0" }, mt: { md: 0, xs: "1rem" } }}>
        ...
        <a style={{textDecoration:"none",color:"#000"}} href={`tel:${ngo.phoneNumber}`}><Typography sx={{ display: "flex", mt: "10px", alignItems: "center", fontSize: "17px", fontWeight: "500" }}><CallRounded sx={{ color: colors.primaryicons, borderRadius: "50%", p: "5px", mr: "7px", border: `2px solid ${colors.primary}` }} />{ngo.phoneNumber}</Typography></a>
        <a style={{textDecoration:"none",color:"#000"}} href={`mailto:${ngo.email}`}><Typography sx={{ display: "flex", mt: "10px", alignItems: "center", fontSize: "17px", fontWeight: "500" }}><EmailRounded sx={{ color: colors.primaryicons, borderRadius: "50%", p: "5px", mr: "7px", border: `2px solid ${colors.primary}` }} />{ngo.email}</Typography></a>
