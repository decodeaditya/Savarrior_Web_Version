    ...
    <Box sx={{ background: "#f1f1f1", p: { md: "4rem 2rem", xs: "4rem 0.7rem" }, textAlign: "center" }}>
      <Grid container sx={{ justifyContent: "space-around", py: "1rem", maxWidth: { md: "89%", xs: "100%" }, margin: "auto", alignItems: "center" }}>
        ...
        <Grid item sx={{ width: { md: "44%", xs: "100%" }, textAlign: "left", p: "10px 20px" }}>
          ...
          <Typography sx={{ display: "flex", alignItems: "center", fontSize: "18px", fontWeight: "600",marginBottom:2,color:"#525252" }}><CheckCircle sx={{ fontSize: {md:"28px",xs:"25px"}, color: colors.primary, background: "#f6f6f6", mr: "8px", borderRadius: "50%", border: `2px solid #167068` }} /> Report and Help Injured Animals Nearby</Typography>
          <Typography sx={{ display: "flex", alignItems: "center", fontSize: "18px", fontWeight: "600",marginBottom:2,color:"#525252"  }}><CheckCircle sx={{ fontSize:  {md:"28px",xs:"25px"}, color: colors.primary, background: "#f6f6f6", mr: "8px", borderRadius: "50%", border: `2px solid #167068` }} /> A Well Curated Vegan Library Build In Collaboration with Vegan Voice!</Typography>
          <Typography sx={{ display: "flex", alignItems: "center", fontSize: "18px", fontWeight: "600",color:"#525252" }}><CheckCircle sx={{ fontSize:  {md:"28px",xs:"25px"}, color: colors.primary, background: "#f6f6f6", mr: "8px", borderRadius: "50%", border: `2px solid #167068` }} /> Get Information About All Nearby Animal NGOs and Vets</Typography>
